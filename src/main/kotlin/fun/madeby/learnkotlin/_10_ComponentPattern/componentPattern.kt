...
package `fun`.madeby.learnkotlin._10_ComponentPattern
...
fun main() {
    ...
    pikeman.addComponent(pikemanHealth.javaClass.simpleName, pikemanHealth)
    pikeman.addComponent(pikemanSpeed.javaClass.simpleName, pikemanSpeed)
    ...
    val pikemanWeapon = pikeman.getComponent("Weapon")
